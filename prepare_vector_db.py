...
# Ham 1: Tao ra vector db tu doan text
def create_db_from_text():
    ...
    # Chia doan text thanh cac doan nho hon
    ...
    print("Done creating vector db from text")
    return db

def create_db_from_pdf():
    # Khai bao loader va load toan bo thu muc pdf
    ...
    db.save_local(vector_db_path)
    print("Done creating vector db from pdf")
    return db
